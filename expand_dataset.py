...
print(f"Dataset saat ini: {exist_count} data. Menambahkan {needed} film baru menuju total 100.000 data...")
...
directors = [
    ...
    "Danial Rifki", "Herwin Novianto", "Viva Westi", "Key Mangunsong",
...
horror_prefixes = ["Kutukan", "Teror", "Misteri", "Arwah", "Tumbal", "Ritual", "Santet", "Pesugihan", "Jeritan", "Dendam", "Hantu", "Kematian", "Perjanjian", "Penglaris", "Bisikan", "Bayangan", "Jejak", "Gerbang", "Jerat", "Tangisan", "Langkah", "Penunggu", "Petaka", "Sumpah", "Belenggu"]
horror_locations = ["Alas", "Desa", "Kamar", "Makam", "Lembah", "Pabrik", "Rumah", "Danau", "Sekolah", "Asrama", "Gua", "Hutan", "Pantai", "Klinik", "Sumur", "Jembatan", "Lorong", "Gedung", "Kampus", "Pondok", "Bukit", "Muara", "Rumah Susun", "Perkebunan", "Pulau", "Bungker"]
horror_nouns = ["Keramat", "Terkutuk", "Berdarah", "Kegelapan", "Maut", "Iblis", "Hitam", "Gaib", "Kuno", "Menjelang Fajar", "Leluhur", "Jahanam", "Kafir", "Tengah Malam", "Merah", "Tanpa Rupa", "Sembilan Malam", "Tak Kasat Mata", "Seribu Jiwa", "Malam Jumat", "Tanpa Kepala", "Tanpa Suara"]

comedy_words = ["Kacau", "Bikin Ribet", "Salah Tangkap", "Mendadak Bos", "Geng", "Jodoh Nyasar", "Ngenes", "Gokil", "Cari Untung", "Mertua Galak", "Piknik Bencana", "Modal Nekat", "Jomblo Akut", "Juragan", "Pusing Tujuh Keliling", "Sultan Kampung", "Salah Alamat", "Keluarga Sableng", "Apes Berat", "Cuan Melayang", "Dilema Bujang", "Rejeki Nomplok"]
drama_words = ["Pelukan", "Rintangan", "Harapan", "Jejak", "Lentera", "Janji", "Duka", "Melodi", "Surat", "Batas", "Senja", "Luka", "Kepingan", "Rindu", "Cahaya", "Pelabuhan", "Suara", "Bintang", "Ruang", "Kenangan", "Gerimis", "Lembayung", "Cakrawala", "Permata", "Pagi Buta", "Rembulan"]
action_words = ["Operasi Gagak", "Serigala Malam", "Garis Depan", "Target Buron", "Darah Pembalasan", "Bayang Baja", "Dendam Hitam", "Serangan Balik", "Konspirasi 88", "Benteng Terakhir", "Sandi Naga", "Pemburu Bayangan", "Misi Garuda", "Mata Rantai", "Detik Menegangkan", "Mandat Baja", "Serbuan Kilat", "Kobra Merah", "Taring Serigala"]
...
for i in range(needed):
    ...
    if genre == "Horor" or genre == "Thriller":
        ...
        title = f"{random.choice(comedy_words)} {random.choice(['Abis', 'Total', 'Keluarga', 'Santuy', 'Season', 'Part 2', 'Lagi', 'Bikin Pusing', 'Gila-Gilaan', 'Hore', 'Mantap', 'Jilid 2', 'Edisi Mudik', 'Reborn'])}"
    elif genre == "Action":
        title = f"{random.choice(action_words)} {random.choice(['Merah', 'Darah', 'Jakarta', 'Khatulistiwa', '24 Jam', 'Terakhir', 'Sektor 9', 'Protokol', 'Nusantara', 'Ultimatum', 'Level Max', 'Alpha'])}"
    elif genre == "Animasi":
        ...
        title = f"{random.choice(drama_words)} di {random.choice(['Ujung Musim', 'Batas Kota', 'Bumi Rafflesia', 'Sudut Ibu Kota', 'Bawah Langit', 'Antara Dua Hati', 'Balik Jendela', 'Lembah Hijau', 'Pesisir Selatan', 'Kala Hujan', 'Tanah Rencong', 'Sudut Kota'])}"
